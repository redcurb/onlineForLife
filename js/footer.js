...
onlineForLife.Footer = {
	...
	setupHandlers: function(){
		...
		$('.feed-share-fb').on('click',function(){
			...
			var url = 'http://m.facebook.com/sharer.php?p[title]='+ title + '&p[summary]=' + description + '&p[url]=' + shareUrl + '&p[images][0]=' + imageUrl;
		...
		$('.feed-share-twitter').on('click',function(){
			...
			var url = "https://twitter.com/intent/tweet?text=Sign%20up%20to%20connect%20with%20me%20on%20Online%20For%20Life&url=http%3A%2F%2Fwww.onlineforlife.org/2-1app/share.html?id=2123";
			window.open(url, '_blank', 'location=yes');
		});
